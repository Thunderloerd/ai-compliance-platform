  ...
  return (
    <PageTransition>
        <div className="space-y-8">
          ...
          {config.apiUrl && (
            <Card className="border-primary/30 bg-primary/5">
              ...
              <CardContent className="space-y-2">
                ...
                {scanMessage && (
                  <p className="text-sm text-emerald-600 dark:text-emerald-400">{scanMessage}</p>
                )}
                {scanError && (
            ...
            <div className="lg:col-span-2">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <h3 className="font-semibold">30-Day Compliance Trend</h3>
                    <p className="text-sm text-muted-foreground">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="lg:col-span-2">
              <Suspense fallback={<div className="h-[240px] animate-pulse rounded-lg bg-muted/30" />}>
