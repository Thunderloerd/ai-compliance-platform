          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <textarea
                ...
                maxLength={500}
              />
              <p className="mt-1 text-xs text-muted-foreground">Max 500 characters. Rate limit applies per user. First question after uploading a new policy may take 1–2 min while the model loads—please wait.</p>
            </div>
            <div>
